(() => {
    ...
    (() => {
        ...
        function menuInit() {
            const menu = document.querySelector(".menu__icons");
            ...
            if (spollersItems) spollersItems.forEach((item => {
                item.addEventListener("click", (function(e) {
                    const target = e.target;
                    if (!target.closest(".spollers__body")) {
                        let elem_active = item.classList.contains("_menu-open");
                        menuItems.forEach((el => {
                            el.classList.remove("_menu-open");
                        }));
                        item.classList.toggle("_menu-open", !elem_active);
                    }
                }));
            }));
        }
                ...
                function setRating(rating) {
                    ...
                    for (let index = 0; index < ratingItems.length; index++) {
                        ...
                        ratingItem.addEventListener("mouseenter", (function(e) {
                            ...
                            let linew = (index + 1) / .05;
                            ratingActive.style.width = `${linew}%`;
                            initRatingVars(rating);
                        }));
                        ratingItem.addEventListener("click", (function(e) {
                            initRatingVars(rating);
                            if (rating.dataset.ajax) setRatingValue(ratingItem.value, rating); else setRatingActiveWidth();
                        }));
                    }
                }
        ...
        class SelectConstructor {
            ...
            selectsInit(selectItems) {
                selectItems.forEach(((originalSelect, index) => {
                    if (!originalSelect.closest(".select")) this.selectInit(originalSelect, index + 1);
                }));
                document.addEventListener("click", function(e) {
            ...
            selectInit(originalSelect, index) {
                if (originalSelect.closest(".select")) return;
                const _this = this;
            ...
            setSelectTitleValue(selectItem, originalSelect) {
                ...
                if (selectItemBody) {
                    const scrollEl = selectItemBody.querySelector(`.${this.selectClasses.classSelectOptions}`);
                    selectItemBody.innerHTML = "";
                    if (scrollEl) selectItemBody.appendChild(scrollEl);
                } else selectItem.insertAdjacentHTML("beforeend", `<div class="${this.selectClasses.classSelectBody}"></div>`);
                const newTitleHTML = this.getSelectTitleValue(selectItem, originalSelect);
                selectItemBody.insertAdjacentHTML("afterbegin", newTitleHTML);
                originalSelect.hasAttribute("data-search") ? this.searchActions(selectItem) : null;
            }
        ...
        if (document.querySelector(".programs__slider")) {
            ...
            function catalogSliderInit() {
                if (!programSlider) programSlider = new core(".programs__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    speed: 800,
        ...
        if (document.querySelector(".learning-levels__sliders")) {
            const thumbsSwiper = new core(".learning-levels__thumbs", {
            ...
            new core(".learning-levels__slider", {
                modules: [ Navigation, Thumb ],
                thumbs: {
                    swiper: thumbsSwiper
                },
        ...
        if (document.querySelector(".learning-block__sliders")) {
            new core(".learning-block__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2.3,
        ...
        if (document.querySelector(".learning-models__sliders")) {
            const thumbsSwiper = new core(".learning-models__thumbs", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            new core(".learning-models__slider", {
                modules: [ Thumb ],
                thumbs: {
                    swiper: thumbsSwiper
                },
        ...
        if (document.querySelector(".teachers__slider")) {
            ...
            function teachersSliderInit() {
                if (!teachersSlider) teachersSlider = new core(".teachers__slider", {
            ...
            window.addEventListener("resize", (function(e) {
                var windowWidth = window.innerWidth;
                if (windowWidth <= mediaQuerySizeTeachers) teachersSliderInit(); else teachersSliderDestroy();
            }));
        }
        ...
        if (document.querySelector(".main-news-slider")) new core(".main-news-slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (reviewsSlider) reviewsSlider.forEach((reviewSlider => {
        ...
        function toggleAudio(button) {
            ...
            allAudios.forEach((audio => {
                if (audio !== targetAudio && !audio.paused) {
                    ...
                    if (associatedButton) associatedButton.classList.remove("playing");
                }
            }));
        ...
        if (selectWrapper) {
            function filterReviews(category) {
                reviewSlides.forEach((slide => {
                    ...
                    if ("1" === category || category === slideCategory) {
            ...
            document.addEventListener("selectCallback", (function(e) {
                ...
                if ("form[]" === selectName && originalSelect.closest(".select-section")) {
            ...
            if (initialSelect) filterReviews(initialSelect.value);
        }
        ...
        if (trialLessonSteps) {
            ...
            function updateSteps(index) {
                ...
                if (trialLessonSteps[index]) trialLessonSteps[index].classList.add("active");
                backButtons.forEach((btn => {
                    if (0 === index) btn.classList.add("disabled"); else btn.classList.remove("disabled");
                }));
            }
